...
const CallToAction: React.FC = () => {
  return (
    <div className="bg-[#09090B] py-16 px-4 sm:px-6">
      <section className="bg-[#FA6A22] w-full py-16 px-12 sm:px-24 lg:px-36 text-white rounded-lg max-w-7xl mx-auto">
        {/* Heading */}
        ...
        {/* Paragraph */}
        <p className="text-base sm:text-lg max-w-3xl mx-auto mb-8 text-left sm:text-center">
